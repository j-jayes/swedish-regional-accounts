...
runtime: shiny
resource_files:
- sverige-lan-counties-of-sweden.shx
- sverige-lan-counties-of-sweden.dbf
- sverige-lan-counties-of-sweden.prj
---
...
df <- read_rds("df.rds")
lan_map <- st_read("sverige-lan-counties-of-sweden.shp") %>%
    rename(lan = lan_namn)
```
